      ...
      <main>
        ...
        <section className="relative h-[80vh] min-h-[600px] w-full overflow-hidden">
          <Image 
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-background via-slate/20 to-transparent" />
          
          <div className="absolute top-32 left-6 right-6 md:left-24 md:right-24 flex justify-between items-start">
            <Link 
              href="/destinations"
          ...
          <div className="absolute bottom-24 left-6 right-6 md:left-24 md:right-24 max-w-4xl">
            <motion.div 
            ...
            <div className="space-y-12">
              <div className="space-y-4">
                ...
                <h3 className="text-5xl font-serif font-bold text-slate leading-tight">
                  Escape the ordinary and <span className="text-terra italic">immerse yourself</span> in local wonder.
                </h3>
              </div>
